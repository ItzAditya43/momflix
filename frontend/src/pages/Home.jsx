    ...
    <div style={{ background: 'var(--bg)', minHeight: '100vh' }}>
      <div className="section">
        <h1 className="hero-greeting" style={{ color: 'var(--text)', marginBottom: '8px' }}>
          Made for you, Mom <span className="hero-heart"><Icon name="heart" size={20} /></span>
        </h1>
        <p className="hero-subtitle" style={{ color: 'var(--text-muted)', fontSize: '18px' }}>
          Simple. Beautiful. Just for you. <Icon name="heart" size={14} />
        </p>
      </div>
        ...
        <div className="section" style={{ marginBottom: '30px' }}>
          <div className="section-header">
            <h2 className="section-title" style={{ color: 'var(--text)', fontSize: '22px' }}>
              <Icon name="clock" size={18} /> Continue Watching
            </h2>
          </div>
      ...
      <div className="section" style={{ marginBottom: '30px' }}>
        <div className="section-header">
          <h2 className="section-title" style={{ color: 'var(--text)', fontSize: '22px' }}>
            <Icon name="flame" size={18} /> Trending This Week
          </h2>
        </div>
        {trending.length === 0 ? (
          <div className="empty-state" style={{ textAlign: 'center', padding: '40px 20px', color: 'var(--text-muted)' }}>
            <h3 style={{ color: 'var(--text)', marginBottom: '12px' }}>
              Welcome to MomFlix! <Icon name="film" size={20} />
            </h3>
